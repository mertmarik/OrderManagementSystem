...
export const updateCustomer = (req: Request, res: Response): void => {
  try {
    ...
    const updatedCustomer = {
      ...
      isActive:
        isActive !== undefined ? isActive : customers[customerIndex].isActive,
      updatedAt: new Date().toISOString(),
    };
...
export const updateCustomerStatus = (req: Request, res: Response): void => {
  try {
    const { id } = req.params;
...
export const deleteCustomer = (req: Request, res: Response): void => {
  try {
    ...
    // Check if customer has orders (in a real app, you'd check the database)
...
export const searchCustomers = (req: Request, res: Response): void => {
  try {
...
export const getCustomerOrders = (req: Request, res: Response): void => {
  try {
    const { id } = req.params;
    ...
    // Mock customer orders - in a real app, you'd fetch from orders table
    const mockOrders = [
      {
        id: "ORD-001",
        orderNumber: "ORD-001",
...
export const getCustomerStats = (req: Request, res: Response): void => {
  try {
